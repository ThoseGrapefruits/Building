...
public class Person extends BuildingObject implements Interactive, Visible, Runnable, Movable {
	...
	public void interact( BuildingObject object ) {
		inUse = true;
		toBeSaid = "This shouldn't even happen, because that would imply some object is interacting with a person. Only people should interact with other people.";
		inUse = false;
	}
		...
		if ( velocityX == 0 ) { // Standing still
			...
			g2d.drawImage(
					head.getSubimage(
							...
							Constants.PERSON_HEAD_HEIGHT, 0 ), ( int ) x, ( int ) y,
					null );
			...
			g2d.drawImage(
					body
							...
							Constants.PERSON_BODY_HEIGHT, 0 ), ( int ) x,
